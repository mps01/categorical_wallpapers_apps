...
public class nature extends AppCompatActivity
    ...
    public void onBackPressed() {
        Intent setIntent = new Intent(nature.this, Dashboard.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference().child("wallpaper").child("nature");
    ...
    private void loadData() {
        ...
        mDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                rc.setAdapter(new MainListAdapter(nature.this, urls));
                rc.setLayoutManager(new GridLayoutManager(nature.this, 3));
                spinKitView.setVisibility(View.GONE);
            }
